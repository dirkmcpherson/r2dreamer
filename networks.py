...
class SIGReg(nn.Module):
    ...
    Measures deviation of embedding distributions from isotropic Gaussian
    using the Epps-Pulley characteristic function statistic.
    Adapted from github.com/james/le-wm.
    """
